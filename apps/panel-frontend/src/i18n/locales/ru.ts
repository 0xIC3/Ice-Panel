...
export default {
  ...
  profiles: {
    ...
    deploy: {
      ...
      hint: 'Отметь ноды, на которых нужен этот профиль. Снятые галки удаляют существующие bindings (cascade — пользователи теряют URL\'ы для этой ноды). Порт по умолчанию: {{port}}.',
