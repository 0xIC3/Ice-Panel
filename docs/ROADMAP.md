...
| 30.1 | **Hosts emission Phase 2** | ⏭️ | URI builders читают `host.alpn` / `allowInsecure` / `securityLayer` (сейчас данные хранятся, но в URI не льются). Драйвер для clash/singbox formatters на ALPN. Drag&drop reorder в UI вместо arrows. |
